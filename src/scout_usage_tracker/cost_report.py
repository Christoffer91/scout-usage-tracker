...
def format_cost_faq(language: str = "en") -> str:
    ...
    if language == "nb":
        return "\n".join([
            ...
            "- `/cost denne uken` — denne chatten denne uken",
            ...
            "- `/cost alle chatter denne uken` — alle Scout-chatter denne uken",
    ...
    return "\n".join([
        ...
        "- `/cost this week` — current chat this week",
        ...
        "- `/cost all chats this week` — all Scout chats this week",
